...
{
  new (message_memory) custom_interfaces::srv::SerialNumber_Request(_init);
}

void SerialNumber_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::srv::SerialNumber_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SerialNumber_Request_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces::srv::SerialNumber_Request, serial_number),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SerialNumber_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::srv::SerialNumber_Request),
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SerialNumber_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, SerialNumber_Request)() {
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SerialNumber_Request_message_type_support_handle;
}
...
void SerialNumber_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) custom_interfaces::srv::SerialNumber_Response(_init);
}

void SerialNumber_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::srv::SerialNumber_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SerialNumber_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::srv::SerialNumber_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SerialNumber_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::srv::SerialNumber_Response),
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SerialNumber_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, SerialNumber_Response)() {
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SerialNumber_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SerialNumber_service_members = {
  ...
  // see get_service_type_support_handle<custom_interfaces::srv::SerialNumber>()
...
get_service_type_support_handle<custom_interfaces::srv::SerialNumber>()
{
  ...
  auto service_type_support =
    &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::SerialNumber_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, SerialNumber)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<custom_interfaces::srv::SerialNumber>();
}
